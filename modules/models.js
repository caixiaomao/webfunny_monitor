...
class CustomerPvLeaveModel {
  ...
  static async calculateCusLeavePercentByHour(webMonitorId, lastHour, hour) {
    ...
    // const userTagSql = userTag ? " and firstUserParam='" + userTag + "' " : ""

    let sql1 = "select count(*) as count from " + tableName + " where  happenDate>='" + lastHour + "' AND happenDate<'" + hour + "' and leaveType=2" // + userTagSql
    let countDataFor2 = await Sequelize.query(sql1, { type: Sequelize.QueryTypes.SELECT})
    let sql2 = "select count(*) as count from " + tableName + " where  happenDate>='" + lastHour + "' AND happenDate<'" + hour + "' and leaveType=1" // + userTagSql
  ...
  static async getCusLeavePercentByTime(param) {
    const timeSql = Utils.handleTimeSqlByTimeSize(param)
    let sql = "SELECT distinct hourName as hour, hourCount as count from InfoCountByHour where webMonitorId='" + param.webMonitorId + "' and uploadType='" + UPLOAD_TYPE.CUS_LEAVE_FOR_HOUR + "' " + timeSql + " order by hourName"
  ...
  static async getCusLeavePercentSevenDayAgoByHour(param) {
    const timeSql = Utils.handleTimeSqlByTimeSizeSeven(param)
    let sql = "SELECT distinct hourName as hour, hourCount as count from InfoCountByHour where webMonitorId='" + param.webMonitorId + "' and uploadType='" + UPLOAD_TYPE.CUS_LEAVE_FOR_HOUR + "' " + timeSql + " order by hourName"
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
   ...
   * 根据参数获取当天的跳出率数据
   */
  static async getCusLeavePercentDataForDay(webMonitorId, lastDay, day) {
    const dateStr = ` and dayName >= '${lastDay}' and dayName <= '${day}' `
    let sql = "select dayName, dayCount from InfoCountByDay where webMonitorId='" + webMonitorId + "'" + dateStr + " and uploadType='" + UPLOAD_TYPE.CUS_LEAVE_FOR_DAY + "' order by dayName desc"
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
}
...
class CustomerStayTimeModel {
  ...
  static async calculateStayTimeByHour(webMonitorId, lastHour, hour) {
    ...
    let sql1 = "select SUM(stayTime) as count from " + tableName + " where  happenDate>='" + lastHour + "' AND happenDate<'" + hour + "' and stayTime>=" + min + " and stayTime<=" + max // + userTagSql
    let sumData = await Sequelize.query(sql1, { type: Sequelize.QueryTypes.SELECT})
    let sql2 = "select count(distinct customerKey) as count from " + tableName + " where  happenDate>='" + lastHour + "' AND happenDate<'" + hour + "' and stayTime>=" + min + " and stayTime<=" + max // + userTagSql
    let countData = await Sequelize.query(sql2, { type: Sequelize.QueryTypes.SELECT})
...
class ExtendBehaviorInfoModel {
  ...
  static async createExtendBehaviorInfo(data) {
    let keys = ""
    let values = ""
    const keyArray = ["id", "userId", "behaviorType", "behaviorResult", "uploadType", "description", "happenTime", "happenDate", "createdAt", "updatedAt"]
    keyArray.forEach((key, index) => {
      if (index == keyArray.length - 1) {
        keys += "`" + key + "`"
        let val = data[key]
    ...
    const proHead = data.webMonitorId
    const dateEnd = new Date(data.happenTime).Format("yyyyMMdd")
    const table = proHead + "ExtendBehaviorInfo" + dateEnd
    let sql = "INSERT INTO " + table + " (" + keys + ") VALUES (" + values + ")"
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.INSERT })
  }
...
class ProjectModel {
  ...
  /**
   * 更新项目的单个字段
   * @param webMonitorId  用户ID
   * @returns {Promise.<boolean>}
   */
  static async updateProjectByField(data) {
    const { webMonitorId } = data
    await Project.update({
      ...data
    }, {
  ...
  static async getProjectList(param) {
    let sql = "select id, webMonitorId, projectName, projectType from Project where FIND_IN_SET(webMonitorId, '" + param.webMonitorIds + "')"
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }

  static async getProjectListByWebMonitorIds(webMonitorIds) {
    let sql = "select * from Project where FIND_IN_SET(webMonitorId, '" + webMonitorIds + "')"
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
  ...
  static async getAllProjectList() {
    ...
    let sql = "select id, webMonitorId, userTag, projectName, projectType, createdAt from Project" + whereSql
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
  /**
   * 获取Project个数
   ...
   * @returns {Promise<*>}
   */
  static async getUserTags(webMonitorId) {
    let sql = "select userTag from Project where webMonitorId='" + webMonitorId + "'"
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
...
class TeamModel {
  ...
  static async getTeamList(userId, userType) {
    ...
    if (userType === "admin") {
      ...
      sql = "select * from Team where leaderId='" + userId + "'"
    }
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
...
class HttpErrorInfoModel {
  ...
  static async getHttpErrorInfoListByHour(param) {
    ...
    const timeSql = Utils.handleTimeSqlByTimeSize(param)
    let sql = "SELECT hourName as hour, hourCount as count from InfoCountByHour where webMonitorId='" + param.webMonitorId + "' and uploadType='" + param.infoType + "' " + timeSql + " order by hourName"
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
  /**
   * 获取7天前，24小时内，每小时的错误量
   ...
   * 计算某一小时接口错误量
   */
  static async calculateHttpErrorCountByHour(webMonitorId, userTag, lastHour, hour) {
    const dateStr = Utils.addDays(-1)
   ...
   * 计算某小时接口错误量影响的用户量
   */
  static async getHttpErrorUserCountByHour(webMonitorId, lastHour, hour) {
    ...
    let sql = "select count(customerKey) as count, count(distinct customerKey) as uvCount  from " + tableName + " WHERE happenDate>='" + lastHour + "' AND happenDate<'" + hour + "'"
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
}
...
class HttpLogInfoModel {
  ...
  static async createHttpLogInfo(data) {
    ...
    let keys = ""
    let values = ""
    const keyArray = [`uploadType`,`happenTime`,`happenDate`,`webMonitorId`,`customerKey`,`simpleUrl`,`completeUrl`,`userId`,`firstUserParam`,`secondUserParam`,`createdAt`,`updatedAt`,`id`,`httpUrl`,`simpleHttpUrl`,`status`,`statusText`,`statusResult`,`loadTime`,`requestText`,`responseText`]
    keyArray.forEach((key, index) => {
      if (index == keyArray.length - 1) {
        keys += "`" + key + "`"
        let val = data[key]
...
class LoadPageInfoModel {
 ...
 /**
   ...
   * @returns {Promise<*>}
   */
  static async getPageCountForLoadTimeByDay(param) {
    let sql = "SELECT dayName as day, dayCount as count from InfoCountByDay where webMonitorId='" + param.webMonitorId + "' and uploadType='" + param.uploadType + "' and dayName='" + param.dayName + "'"
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
  /**
   * 根据时间分类获取接口列表
...
class ResourceLoadInfoModel {
   ...
   * 计算某一小时静态资源加载错误量
   */
  static async calculateResourceErrorCountByHour(webMonitorId, userTag, lastHour, hour) {
    const dateStr = Utils.addDays(-1)
  ...
  /**
   * 计算某小时静态资源加载错误量影响用户数量
   */
  static async getResourceErrorUserCountByHour(webMonitorId, lastHour, hour) {
    const dateStr = Utils.addDays(-1)
    let tableName = CommonSql.setTableName("ResourceLoadInfo", 0, webMonitorId) // Utils.setTableName("ResourceLoadInfo")
    if (lastHour === dateStr + " 23:00:00") {
      tableName = CommonSql.setTableName("ResourceLoadInfo", 1, webMonitorId)
...
class JavascriptErrorInfoModel {
  ...
  static async getConsoleErrorSort(param) {
    ...
    const sql = "select errorMessage, count(errorMessage) as count from " + tableName + " where infoType='console_error' " + queryStr + " GROUP BY errorMessage order by count desc limit 20"
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
  /**
  ...
  static async getJavascriptErrorStackCodeForSource(line, column) {
    ...
    if (rawSourceMap.indexOf("sourcesContent") == -1) {
      ...
      sourceCode.push({line: sm.line - 5, code: rawLines[sm.line - 5]})
      sourceCode.push({line: sm.line - 4, code: rawLines[sm.line - 4]})
      sourceCode.push({line: sm.line - 3, code: rawLines[sm.line - 3]})
      sourceCode.push({line: sm.line - 2, code: rawLines[sm.line - 2]})
      sourceCode.push({line: sm.line - 1, code: rawLines[sm.line - 1]})
      sourceCode.push({line: sm.line - 0, code: rawLines[sm.line - 0]})
      sourceCode.push({line: sm.line + 1, code: rawLines[sm.line + 1]})
      sourceCode.push({line: sm.line + 2, code: rawLines[sm.line + 2]})
      sourceCode.push({line: sm.line + 3, code: rawLines[sm.line + 3]})
    }
   ...
   * 计算某一小时on_error的量
   */
  static async calculateJsErrorCountByHour(webMonitorId, userTag, lastHour, hour) {
    const dateStr = Utils.addDays(-1)
    ...
    let sql = "select count(*) as count from " + tableName + " WHERE happenDate>='" + lastHour + "' AND happenDate<'" + hour + "' AND infoType='on_error'" + userTagSql
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
  /**
   * 计算某一小时console_error的量
   */
  static async calculateConsoleErrorCountByHour(webMonitorId, userTag, lastHour, hour) {
    const dateStr = Utils.addDays(-1)
    ...
    let sql = "select count(*) as count from " + tableName + " WHERE happenDate>='" + lastHour + "' AND happenDate<'" + hour + "' AND infoType='console_error'" + userTagSql
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
  /**
   * 计算某一天on_error的量
   ...
   * 计算某小时影响的用户数量
   */
  static async getJsErrorUserCountByHour(webMonitorId, lastHour, hour) {
    const dateStr = Utils.addDays(-1)
    let tableName = CommonSql.setTableName("JavascriptErrorInfo", 0, webMonitorId)
    if (lastHour === dateStr + " 23:00:00") {
      tableName = CommonSql.setTableName("JavascriptErrorInfo", 1, webMonitorId)
    }
    let sql = "select count(customerKey) as count, count(distinct customerKey) as uvCount from " + tableName + " WHERE happenDate>='" + lastHour + "' AND happenDate<'" + hour + "' AND infoType='on_error'"
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
  /**
   * 计算某一天console_error的量
  ...
  /**
   * 计算某小时console_error的量
   */
  static async getConsoleErrorUserCountByHour(webMonitorId, lastHour, hour) {
    ...
    let sql = "select count(customerKey) as count, count(distinct customerKey) as uvCount  from " + tableName + " WHERE happenDate>='" + lastHour + "' AND happenDate<'" + hour + "' AND infoType='console_error'"
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
...
class CustomerPVModel {
   ...
   * 根据参数获取当天的pv数量
   */
  static async getPVFlowDataForDay(webMonitorId, lastDay, day, chooseUserTag) {
    const dateStr = ` and dayName >= '${lastDay}' and dayName <= '${day}' `
    let sql = "select dayName, dayCount from InfoCountByDay where webMonitorId='" + webMonitorId + "'" + dateStr + " and uploadType='" + UPLOAD_TYPE.PV_COUNT_DAY + chooseUserTag + "' order by dayName desc"
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
  /**
   * 根据参数获取当天的uv数量
   */
  static async getUVFlowDataForDay(webMonitorId, lastDay, day, chooseUserTag) {
    const dateStr = ` and dayName >= '${lastDay}' and dayName <= '${day}' `
    let sql = "select dayName, dayCount from InfoCountByDay where webMonitorId='" + webMonitorId + "'" + dateStr + " and uploadType='" + UPLOAD_TYPE.UV_COUNT_DAY + chooseUserTag + "' order by dayName desc"
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
   ...
   * 根据参数获取当天的新客户数量
   */
  static async getNewFlowDataForDay(webMonitorId, lastDay, day, chooseUserTag) {
    const dateStr = ` and dayName >= '${lastDay}' and dayName <= '${day}' `
    let sql = "select dayName, dayCount from InfoCountByDay where webMonitorId='" + webMonitorId + "'" + dateStr + " and uploadType='" + UPLOAD_TYPE.NEW_COUNT_DAY + chooseUserTag + "' order by dayName desc"
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
   ...
   * 根据参数获取当天的IP数量
   */
  static async getIpFlowDataForDay(webMonitorId, lastDay, day, chooseUserTag) {
    const dateStr = ` and dayName >= '${lastDay}' and dayName <= '${day}' `
    let sql = "select dayName, dayCount from InfoCountByDay where webMonitorId='" + webMonitorId + "'" + dateStr + " and uploadType='" + UPLOAD_TYPE.IP_COUNT_DAY + chooseUserTag + "' order by dayName desc"
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
  ...
  static async getUVCountForDay(webMonitorId, day, uploadTypeForHour) {
    ...
    let useDay = Utils.addDays(0 - day)
    const startHour = useDay.substring(5) + " 00"
    const endHour = useDay.substring(5) + " 23"
    let sql1 = "SELECT SUM(hourCount) as count from InfoCountByHour where hourName>='" + startHour + "' and hourName<='" + endHour + "' and webMonitorId='" + webMonitorId + "' and uploadType='" + uploadTypeForHour + "'"
   ...
   * 获取今天的分布数据
   */
  static async getProvinceCountByDay(param) {
    const {webMonitorId, timeSize} = param
    const uploadTypeForDay = UPLOAD_TYPE.PROVINCE_COUNT_DAY
    let dayName = Utils.addDays(0 - timeSize)
    let sql1 = "SELECT showName as name, dayCount as value from DeviceInfoCountByDay where dayName='" + dayName + "' and webMonitorId='" + webMonitorId + "' and uploadType='" + uploadTypeForDay + "'"
    return await Sequelize.query(sql1, { type: Sequelize.QueryTypes.SELECT})
    // const tableName = CommonSql.setTableName("CustomerPV", 0, param.webMonitorId)
    // let sql = "SELECT province as name, count(distinct customerKey) as value from " + tableName + " GROUP BY province"
    // return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
  /**
   * 获取今天的分布数据
   */
  static async getCountryCountByDay(param) {
    const {webMonitorId, timeSize} = param
    const uploadTypeForDay = UPLOAD_TYPE.COUNTRY_COUNT_DAY
    let dayName = Utils.addDays(0 - timeSize)
    let sql1 = "SELECT showName as name, dayCount as value from DeviceInfoCountByDay where dayName='" + dayName + "' and webMonitorId='" + webMonitorId + "' and uploadType='" + uploadTypeForDay + "'"
    return await Sequelize.query(sql1, { type: Sequelize.QueryTypes.SELECT})
    ...
    // const tableName = CommonSql.setTableName("CustomerPV", 0, param.webMonitorId)
    // let sql = "SELECT country as name, count(distinct customerKey) as value from " + tableName + " GROUP BY country"
    // return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
  /**
   * 获取每个标签的uv人数
   */
  static async getTagsPercent(param) {
    const {webMonitorId, timeSize} = param
    const uploadTypeForDay = UPLOAD_TYPE.UV_COUNT_DAY
    let dayName = Utils.addDays(0 - timeSize)
    let sql1 = "SELECT uploadType as name, dayCount as value from InfoCountByDay where webMonitorId='" + webMonitorId + "' and dayName='" + dayName + "' and uploadType like '" + uploadTypeForDay + "%' and uploadType!='" + uploadTypeForDay + "' order by value desc"
    return await Sequelize.query(sql1, { type: Sequelize.QueryTypes.SELECT})
  }
  /**
   * 每5分钟Uv量
  ...
  static async getUvCountByHour(param) {
    const timeSql = Utils.handleTimeSqlByTimeSize(param)
    const uploadType = "uv" + param.chooseUserTag
    let sql = "SELECT distinct hourName as hour, hourCount as count from InfoCountByHour where webMonitorId='" + param.webMonitorId + "' and uploadType='" + uploadType + "' " + timeSql + " order by hourName"
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
  /**
   * 获取7天前，24小时内，每小时的UV量
  ...
  static async getPvCountByTime(param) {
    const timeSql = Utils.handleTimeSqlByTimeSize(param)
    const uploadType = UPLOAD_TYPE.PV_COUNT_HOUR + param.chooseUserTag
    let sql = "SELECT distinct hourName as hour, hourCount as count from InfoCountByHour where webMonitorId='" + param.webMonitorId + "' and uploadType='" + uploadType + "' " + timeSql + " order by hourName"
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
  /**
  ...
  static async getNewCustomerCountByTime(param) {
    const timeSql = Utils.handleTimeSqlByTimeSize(param)
    const uploadType = UPLOAD_TYPE.NEW_CUSTOMER + param.chooseUserTag
    let sql = "SELECT distinct hourName as hour, hourCount as count from InfoCountByHour where webMonitorId='" + param.webMonitorId + "' and uploadType='" + uploadType + "' " + timeSql + " order by hourName"
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
  /**
   ...
   * 获取城市top20数量列表
   */
  static async getCityCountOrderByCountTop20(param) {
    const {webMonitorId} = param
    const uploadTypeForDay = UPLOAD_TYPE.CITY_COUNT_DAY
    const day = 0
    let dayName = Utils.addDays(day)
    let sql1 = "SELECT showName, dayCount as count from DeviceInfoCountByDay where dayName='" + dayName + "' and webMonitorId='" + webMonitorId + "' and uploadType='" + uploadTypeForDay + "' order by count desc limit 20"
    return await Sequelize.query(sql1, { type: Sequelize.QueryTypes.SELECT})
  }
  ...
  static async getPvListTotalCountByTime(param) {
    let {searchDate, searchHour, webMonitorId, ip} = param
    const searchDateStr = searchDate.replace(/-/g, '')
    ...
    const ipAddressStr = ip ? " and monitorIp='" + ip + "' " : ""
    const tableName = webMonitorId + "CustomerPV" + searchDateStr  // CommonSql.setTableName("CustomerPV", timeScope, webMonitorId)
    const sql = `select count(*) as count from ${tableName} where ${happenDateSql} ${ipAddressStr} `
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }

  static async getPvListByPage(param) {
    let {searchDate, searchHour, webMonitorId, page, pageSize, ip} = param
    const searchDateStr = searchDate.replace(/-/g, '')
    const happenDateScope = searchDate + " " + searchHour + ":00:00"
    const happenDateScopeEnd = searchDate + " " + searchHour + ":59:59"
    const happenDateSql = searchHour === -1 ? " 1=1 " : " happenDate>='" + happenDateScope + "' and happenDate<='" + happenDateScopeEnd + "' "
    const ipAddressStr = ip ? " and monitorIp='" + ip + "' " : ""
    const tableName = webMonitorId + "CustomerPV" + searchDateStr  // CommonSql.setTableName("CustomerPV", timeScope, webMonitorId)
    const sql = `select * from ${tableName} where ${happenDateSql} ${ipAddressStr} limit ${(page - 1) * pageSize},${page * pageSize}`
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
   ...
   * 计算某一小时的Pv量
   */
  static async calculatePvCountByHour(webMonitorId, userTag, lastHour, hour) {
    const dateStr = Utils.addDays(-1)
    let tableName = CommonSql.setTableName("CustomerPV", 0, webMonitorId)
    if (lastHour === dateStr + " 23:00:00") {
      tableName = CommonSql.setTableName("CustomerPV", 1, webMonitorId)
    ...
    let sql = "select count(*) as count from " + tableName + " WHERE happenDate>='" + lastHour + "' AND happenDate<'" + hour + "'" + userTagSql
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
   ...
   * 计算某一小时的新用户活跃量
   */
  static async calculateNewCustomerCountByHour(webMonitorId, userTag, lastHour, hour) {
    const dateStr = Utils.addDays(-1)
    let tableName = CommonSql.setTableName("CustomerPV", 0, webMonitorId)
    if (lastHour === dateStr + " 23:00:00") {
      tableName = CommonSql.setTableName("CustomerPV", 1, webMonitorId)
    ...
    let sql = "select count(distinct customerKey) as count from " + tableName + " WHERE happenDate>='" + lastHour + "' AND happenDate<'" + hour + "' and (newStatus='n' or newStatus='n_uv' ) " + userTagSql
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
   ...
   * 计算某一小时的ip数量
   */
  static async calculateTotalIPCountByHour(webMonitorId, userTag, lastHour, hour) {
    const dateStr = Utils.addDays(-1)
    let tableName = CommonSql.setTableName("CustomerPV", 0, webMonitorId)
    if (lastHour === dateStr + " 23:00:00") {
      tableName = CommonSql.setTableName("CustomerPV", 1, webMonitorId)
    ...
    let sql = "select count(distinct monitorIp) as count from " + tableName + " WHERE happenDate>='" + lastHour + "' AND happenDate<'" + hour + "' and (newStatus='o_uv' or newStatus='n_uv' ) " + userTagSql
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
  /**
   * 计算某一小时的新用户唯一数量
   */
  static async calculateTotalNewCustomerCountByHour(webMonitorId, userTag, lastHour, hour) {
    const dateStr = Utils.addDays(-1)
    let tableName = CommonSql.setTableName("CustomerPV", 0, webMonitorId)
    if (lastHour === dateStr + " 23:00:00") {
      tableName = CommonSql.setTableName("CustomerPV", 1, webMonitorId)
    ...
    let sql = "select count(distinct customerKey) as count from " + tableName + " WHERE happenDate>='" + lastHour + "' AND happenDate<'" + hour + "' and newStatus='n_uv'" + userTagSql
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
   ...
   * 计算某一小时的Uv活跃量
   */
  static async calculateUvCountByHour(webMonitorId, userTag, lastHour, hour) {
    const dateStr = Utils.addDays(-1)
    ...
    let sql = "select count(DISTINCT customerKey ) as count from " + tableName + " WHERE happenDate>='" + lastHour + "' AND happenDate<'" + hour + "'" + userTagSql
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
   ...
   * 计算某一小时的Uv唯一数量
   */
  static async calculateTotalUvCountByHour(webMonitorId, userTag, lastHour, hour) {
    const dateStr = Utils.addDays(-1)
    let tableName = CommonSql.setTableName("CustomerPV", 0, webMonitorId) // Utils.setTableName("CustomerPV")
    if (lastHour === dateStr + " 23:00:00") {
      tableName = CommonSql.setTableName("CustomerPV", 1, webMonitorId)
    ...
    let sql = "select count(DISTINCT(customerKey)) as count from " + tableName + " WHERE happenDate>='" + lastHour + "' AND happenDate<'" + hour + "' and ( newStatus='o_uv' or newStatus='n_uv' ) " + userTagSql
    return await Sequelize.query(sql, { type: Sequelize.QueryTypes.SELECT})
  }
